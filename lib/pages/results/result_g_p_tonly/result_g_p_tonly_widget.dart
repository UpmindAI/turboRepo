  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UserCompletionsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserCompletionsRecord> resultGPTonlyUserCompletionsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final resultGPTonlyUserCompletionsRecord =
            resultGPTonlyUserCompletionsRecordList.isNotEmpty
                ? resultGPTonlyUserCompletionsRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
                                            ...
                                            children: [
                                                        ...
                                                        child: InkWell(
                                                          onTap: () async {
                                                            await Clipboard.setData(
                                                                ClipboardData(
                                                                    text:
                                                                        'Prompt:     ${resultGPTonlyUserCompletionsRecord!.prompt}Completion:     ${resultGPTonlyUserCompletionsRecord!.completion}'));
                                                            ScaffoldMessenger
                                                                    .of(context)
                                                                .showSnackBar(
                                                              SnackBar(
                                              ...
                                              Align(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: SelectionArea(
                                                      child: Text(
                                                    resultGPTonlyUserCompletionsRecord!
                                                        .completion!,
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyText1
                                          ...
                                          Expanded(
                                            child: Stack(
                                              children: [
                                                ...
                                                if (resultGPTonlyUserCompletionsRecord!
                                                            .url !=
                                                        null &&
                                                    resultGPTonlyUserCompletionsRecord!
                                                            .url !=
